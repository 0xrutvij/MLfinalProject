...
if __name__ == '__main__':
    ...
    for fileKey in keys:
        ...
        utils.compute_error(ytest, pred0)
        print('-*-'*10)
        model1 = XGBClassifier(n_estimators=10, scale_pos_weight=1000, use_label_encoder=False, eval_metric='error', verbosity = 0).fit(xtrain, ytrain)
        ...
        utils.compute_error(ytest, pred1)
        print('-+-'*10)
        print('-+-'*10)